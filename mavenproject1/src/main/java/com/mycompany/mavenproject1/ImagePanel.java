...
public class ImagePanel extends JPanel {
    ...
    /**
     * Construtor que irá receber a imagem e defini-la como existindo no fundo do
     * painel.
     * 
    ...
    public ImagePanel(URL url) {
         ...
         * os sets fizerem alguma validação. Neste caso é simplesmente para não repetir
         * o mesmo código
         */
        setImage(url);

        // Fundamental que a propriedade seja coloca a false ou a imagem não vai
        // aparecer
        setOpaque(false);
    ...
    public void paintComponent(Graphics g) {
        /*
         * A imagem vai ser desenhada em x=0, y=0 e usando o tamanho real da imagem é
         * fundamental que seja chamado o método drawImage antes de se chamar o método
         * paintComponent da superclasse.
         */
        g.drawImage(image, 0, 0, this);

        /*
         * Ao desenharmos primeiro a imagem garantimos que qualquer componente que seja
         * adicionado ao painel fique por cima da imagem, criando assim o efeito de
         * imagem de background que pretendemos.
         *
         * Se trocarmos a ordem, os efeitos podem não ser os esperados já que a imagem
         * vai ser desenhada em cima dos componentes que estão neste JPanel. Se não
         * existirem componente então a ordem não é relevante.
         */
