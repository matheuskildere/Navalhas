...
public class AddClientes extends JPanel implements ActionListener {
    ...
    public AddClientes() {
        ...
        customerIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/icons/customer-add1.png")));
        ...
        bBiometria.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/icons/digital-button.png")));
