...
public class Relatorios extends JPanel implements ActionListener {
    ...
    public Relatorios(RelatoriosDiario relDia, RelatoriosSemanal relSem, JPanel relMes, RelatoriosAnual relAnu) {
        ...
        bDiario = new JButton();
        bDiario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/icons/circle-button.png")));
        ...
        bSemanal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/icons/circle-button.png")));
        ...
        bMensal = new JButton();
        bMensal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/icons/circle-button.png")));
        ...
        bAnual = new JButton();
        bAnual.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ui/icons/circle-button.png")));
